...
export default function CajaPage() {
  ...
  if (loading) {
    return <div className="flex items-center justify-center min-h-screen text-gray-400 font-medium">Cargando caja...</div>
  }
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-end justify-center" onClick={closeModal}>
          <div className="w-full max-w-md bg-white rounded-t-3xl shadow-2xl flex flex-col max-h-[88vh]"
