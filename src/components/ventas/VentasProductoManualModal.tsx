...
export function VentasProductoManualModal({ open, onClose, onAdd }: Props) {
  ...
  const handleAdd = () => {
    ...
    onAdd(name.trim() || "Producto manual", priceNum)
    onClose()
  }
      ...
      >
        ...
        >
          <div className="flex items-center justify-between px-5 py-4 border-b border-slate-200 shrink-0">
            <h2 className="text-lg font-bold text-slate-800">Producto manual</h2>
            <button
              type="button"
              onClick={onClose}
          ...
          <div className="overflow-y-auto flex-1 min-h-0 p-5 pb-8 space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <Button
                onClick={handleAdd}
                disabled={!(parseFloat(price.replace(",", ".")) >= 0)}
